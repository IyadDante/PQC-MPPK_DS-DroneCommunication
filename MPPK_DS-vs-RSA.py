...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb 28 03:21:56 2023
...
def decrypt(cipher_text, private_key):
    d, N = private_key
    message = [chr(pow(c, d, N)) for c in cipher_text]
    return "".join(message)
end_time = time.time()
...
# Print the results
print(f"RSA key generation time: {key_gen_time:.6f} milliseconds")
print(f"RSA encryption time: {encrypt_time:.6f} milliseconds")
print(f"RSA decryption time: {decrypt_time:.6f} milliseconds")
...
#cProfile.run('S(s, mu, m, n, lambda_, ell, p)')
# End the timer
end_time = time.time()
...
# Print the signing latency in milliseconds
print('Signing latency:', latency, 'milliseconds')
...
# Print the signing latency in milliseconds
print('verifying latency:', latency, 'milliseconds')
